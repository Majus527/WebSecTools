...
from webscan_backend.plugins.common.common import getdomain
...
def get_web_weight(domain):
    ...
    api_url = "https://apistore.aizhan.com/baidurank/siteinfos/ad21ff9a057bb0acc3cc57770cc8c1d9?domains="
    try:
...
if __name__ == '__main__':
    print(get_web_weight('http://www.aizhan.com'))
